            ...
            <form className="py-1" onSubmit={handlesubmit}>
              <div className="flex flex-col item-center gap-2 ">
                ...
                <div className='name flex w-2/3 gap-20' style={{width : "100%"}}>
                    ...
                    <input className='textbox' placeholder='End Date' type='text' value={Sval}
                ...
                <input className='textbox' placeholder='Total Weight of Harvest' type='text' value={Wval}
                        onChange={(e)=>{setWval(e.target.value)}} />
                               
                <input className='textbox' placeholder='Harvest Storage Temperature' type='text' value={Tval}
                        onChange={(e)=>{setTval(e.target.value)}} />
                <br/>
                <button className="btn" type="submit" onClick={handleClick}>Save</button>
                </div>
              </form>
          </div>
